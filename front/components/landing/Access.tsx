...
export default function Access() {
  return (
    <section className="relative py-24 px-6 overflow-hidden">
      {/* 🔥 IMAGEN DE FONDO */}
      <Image
        src="/imagenlogin.jpg" // 👉 asegurate que exista en /public
        alt="Fondo acceso"
        fill
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {/* CARD 1 */}
          <div className="group bg-white/90 backdrop-blur-md p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all border border-outline-variant hover:border-primary cursor-pointer flex flex-col justify-between">
            <div>
          ...
          {/* CARD 4 */}
          <div className="group bg-primary/90 backdrop-blur-md p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all border border-primary cursor-pointer flex flex-col justify-between">
            <div>
